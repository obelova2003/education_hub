    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_date_of_start', models.DateField(auto_now=True, verbose_name='Дата начала курса')),
                ...
                ('course_categories', models.ManyToManyField(to='course.categories', verbose_name='Категории')),
            ],
            options={
                'verbose_name': 'Курс',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_course', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='course.courses', verbose_name='Курс')),
            ],
            options={
                'verbose_name': 'Урок',
