# Generated by Django 4.2.17 on 2025-02-17 11:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Преподаватель курса')),
            ],
            options={
                'verbose_name': 'Курс',
